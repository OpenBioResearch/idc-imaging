...
def extract_relevant_metadata(dicom_data):
    """Extracts relevant DICOM tags to help identify image type, manufacturer and modality focus.  May contain duplicate metadata.  Please use nonduplicates script for diversity.
...
# Select the first folder (You can customize this logic)
if folder_prefixes:
    selected_folder_prefix = folder_prefixes[0]
else:
